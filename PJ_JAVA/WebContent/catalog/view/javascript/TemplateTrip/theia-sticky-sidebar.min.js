                    ...
                    a.stickySidebar.css("padding-top", 1), a.stickySidebar.css("padding-bottom", 1), s -= a.stickySidebar.offset().top, d = a.stickySidebar.outerHeight() - d - s, 0 == s ? (a.stickySidebar.css("padding-top", 0), a.stickySidebarPaddingTop = 0) : a.stickySidebarPaddingTop = 1, 0 == d ? (a.stickySidebar.css("padding-bottom", 0), a.stickySidebarPaddingBottom = 0) : a.stickySidebarPaddingBottom = 1, a.previousScrollTop = null, a.fixedScrollTop = 0, e(), a.onScroll = function(a) {
                        if (a.stickySidebar.is(":visible")) {
                            ...
                            if (s >= a.sidebar.offset().top + (a.paddingTop - a.options.additionalMarginTop)) {
                                var r, c = a.paddingTop + t.additionalMarginTop,
                                ...
                                r = h ? f + a.stickySidebar.outerHeight() : i(window).height() - a.marginBottom - a.paddingBottom - t.additionalMarginBottom;
                                var g = b - s + a.paddingTop,
                                    u = l - s - a.paddingBottom - a.marginBottom,
                                    S = a.stickySidebar.offset().top - s,
                                    m = a.previousScrollTop - s;
                                "fixed" == a.stickySidebar.css("position") && "modern" == a.options.sidebarBehavior && (S += m), "stick-to-top" == a.options.sidebarBehavior && (S = t.additionalMarginTop), "stick-to-bottom" == a.options.sidebarBehavior && (S = r - a.stickySidebar.outerHeight()), S = m > 0 ? Math.min(S, f) : Math.max(S, r - a.stickySidebar.outerHeight()), S = Math.max(S, g), S = Math.min(S, u - a.stickySidebar.outerHeight());
                                var y = a.container.height() == a.stickySidebar.outerHeight();
                                d = !y && S == f || !y && S == r - a.stickySidebar.outerHeight() ? "fixed" : s + S - a.sidebar.offset().top - a.paddingTop <= t.additionalMarginTop ? "static" : "absolute"
                            }
                            if ("fixed" == d) {
