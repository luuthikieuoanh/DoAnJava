! function(e) {
    e.belowthefold = function(t, o) {
        return e(window).height() + e(window).scrollTop() <= e(t).offset().top - o.threshold
    }, e.abovethetop = function(t, o) {
        return e(window).scrollTop() >= e(t).offset().top + e(t).height() - o.threshold
    }, e.rightofscreen = function(t, o) {
        return e(window).width() + e(window).scrollLeft() <= e(t).offset().left - o.threshold
    }, e.leftofscreen = function(t, o) {
        return e(window).scrollLeft() >= e(t).offset().left + e(t).width() - o.threshold
