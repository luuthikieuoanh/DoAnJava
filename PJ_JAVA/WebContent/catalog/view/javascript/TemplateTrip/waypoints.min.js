! function(t, e, o, n, i) {
        ...
        u = {
            init: function(n, i) {
                return this.each(function() {
                    var s, l = t.fn[e].defaults.context,
                        u = t(this);
                    i && i.context && (l = i.context), t.isWindow(l) || (l = u.closest(l)[0]), (s = function(e) {
                        var o = null;
                        return t.each(c, function(t, n) {
                            if (n.element[0] === e) return o = n, !1
                        }), o
                    }(l)) || (s = new h(l), c.push(s));
                    var p = f(u, s),
                        a = p < 0 ? t.fn[e].defaults : s.waypoints[p].options,
                        d = t.extend({}, a, i);
                    d.offset = "bottom-in-view" === d.offset ? function() {
                        return (t.isWindow(l) ? t[o]("viewportHeight") : t(l).height()) - t(this).outerHeight()
                    } : d.offset, p < 0 ? s.waypoints.push({
                        element: u,
                        offset: null,
                        options: d
                    }) : s.waypoints[p].options = d, n && u.bind(r, n), i && i.handler && u.bind(r, i.handler)
                }), t[o]("refresh"), this
            },
            remove: function() {
        ...
        p = {
            refresh: function() {
                t.each(c, function(e, n) {
                    var i = t.isWindow(n.element[0]),
                        s = i ? 0 : n.element.offset().top,
                        r = i ? t[o]("viewportHeight") : n.element.height(),
                        f = i ? 0 : n.element.scrollTop();
                    t.each(n.waypoints, function(t, e) {
                        if (e) {
                            var o = e.options.offset,
                                i = e.offset;
                            if ("function" == typeof e.options.offset) o = e.options.offset.apply(e.element);
    ...
    t.fn[e] = function(o) {
        return u[o] ? u[o].apply(this, Array.prototype.slice.call(arguments, 1)) : "function" != typeof o && o ? "object" == typeof o ? u.init.apply(this, [null, o]) : void t.error("Method " + o + " does not exist on jQuery " + e) : u.init.apply(this, arguments)
    }, t.fn[e].defaults = {
        continuous: !0,
        offset: 0,
        triggerOnce: !1,
        ...
        return p[t] ? p[t].apply(this) : p.aggregate()
    }, t[o].settings = {
        resizeThrottle: 200,
        scrollThrottle: 100
    }, s.load(function() {
