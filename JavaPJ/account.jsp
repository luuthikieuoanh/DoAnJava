...
<base href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/" />
...
<div class="container">
	<div class="header-left">
		 <div id="logo"><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=common/home"><img src="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/image/catalog/logo.png" title="Your Store" alt="Your Store" class="img-responsive" /></a>      	</div>
	</div>
		...
		<button type="button" class="btn btn-default btn-lg"><i class="material-icons icon-search">search</i></button>
			...
			<li class="account-nav dropdown header_user_info"><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/account" title="Account" class="dropdown-toggle" data-toggle="dropdown"><i class="material-icons user">perm_identity</i><span class="ttuserheading">Account</span><i class="material-icons expand-more">expand_more</i></a>
			  <ul class="dropdown-menu dropdown-menu-right account-link-toggle">
								<li><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/account"><i class='material-icons ma-user'>perm_identity</i> My account</a></li>
				...
				<li><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/download"><i class='material-icons save-alt'>save_alt</i> Downloads</a></li>
				...
				<li><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/logout"><i class="material-icons">lock_open</i> Logout</a></li>
  ...
  <form action="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
    ...
    <input type="hidden" name="redirect" value="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/account" />
  </form>
</div>
</li>
...
<ul class="dropmenu">
			...
			<div class="dropdown-inner">
									...
									<li class="TT-Sub-List"> <a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=information/tt_blog/blogs">
  ...
  <ul class="breadcrumb">
	...
	<h1 class="page-title">My account</h1>
      ...
      <ul class="list-unstyled">
        <li><a href="edit">Edit your account information</a></li>
        <li><a href="password">Change your password</a></li>
        <li><a href="address">Modify your address book entries</a></li>
        <li><a href="wishlist">Modify your wish list</a></li>
      </ul>
      ...
      <ul class="list-unstyled">
        ...
        <li><a href="download">Downloads</a></li>
                <li><a href="reward">Your Reward Points</a></li>
                <li><a href="return">Returns</a></li>
        <li><a href="transaction">Transactions</a></li>
        <li><a href="recurring">Payment Profile</a></li>
      </ul>
	  </div><!-- a-link-content END -->
	  </div>
...
<ul class="list-unstyled">
    ...
    <li class="instagram"><a href="#"><p>instagram</p></a></li>
