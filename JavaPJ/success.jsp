				...
				<div class="full-header">
					<div class="container">
						<div class="header-left">
							<div id="logo"><a href="index.php"><img src="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/image/catalog/logo.png" title="Your Store" alt="Your Store" class="img-responsive" /></a> </div>
						</div>
								...
								<ul class="list-inline">
									...
									<li class="account-nav dropdown header_user_info"><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/account" title="Account" class="dropdown-toggle" data-toggle="dropdown"><i class="material-icons user">perm_identity</i><span class="ttuserheading">Account</span><i class="material-icons expand-more">expand_more</i></a>
										<ul class="dropdown-menu dropdown-menu-right account-link-toggle">
											<li><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/login"><i class="material-icons">lock</i> Login</a></li>
											<li><a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/register"><i class='material-icons reg-person'>person</i> Register</a></li>
											...
											<li class="ttlanguage">
												<div class="pull-left">
													<form action="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
														...
														<input type="hidden" name="redirect" value="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=account/success" />
													</form>
												</div>
											</li>
											<li class="ttcurrency">
		...
		<div id="common-success" class="container">
			...
			<div class="row">
				<div id="content" class="col-sm-12">
					...
					<p>Thank you for registering with Your Store!</p>
					<p>You will be notified by e-mail once your account has been activated by the store owner.</p>
					<p>If you have ANY questions about the operation of this online shop, please <a href="https://demo.templatetrip.com/Opencart/OPC01/OPC009/OPC04/index.php?route=information/contact">contact the store owner</a>.</p>
					<div class="buttons">
						<div class="pull-right"><a href="login.jsp" class="btn btn-primary">Continue</a></div>
					</div>
					<script>
						var Tawk_API = {},
